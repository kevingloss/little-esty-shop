...
RSpec.describe Invoice do
  ...
  it 'filters to only a specific merchants items' do
    ...
    item_x = merchant_2.items.create!(name: "Item_11", description: "Description_11", unit_price: 150)
    invoice_1 = @customer_1.invoices.create!
    ii_1 = invoice_1.invoice_items.create!(item_id: item_x.id, quantity: 5, unit_price: item_x.unit_price, status: 1)
    ...
    expect(invoice_1.merchant_items(@merchant_1)).to eq([ii_2, ii_3, ii_4, ii_5].sort)
  end
